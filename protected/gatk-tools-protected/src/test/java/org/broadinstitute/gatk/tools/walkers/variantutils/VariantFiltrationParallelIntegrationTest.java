...
public class VariantFiltrationParallelIntegrationTest extends WalkerTest {

    private class ParallelVariantFiltrationTestProvider extends TestDataProvider {
        final String reference;
        final String args;
        final String md5;
        final int nt;

        private ParallelVariantFiltrationTestProvider(final String reference, final String args, final String md5, final int nt) {
            super(ParallelVariantFiltrationTestProvider.class);
        ...
        public final String getCmdLine() {
            return "-T VariantFiltration -R " + reference + " -o %s --no_cmdline_in_header -nt " + nt + " " + args;
        }

        public String toString() {
            return String.format("ParallelVariantFiltration nt=%d args=%s", nt, args);
        }
    }

    @DataProvider(name = "ParallelVariantFiltrationTest")
    public Object[][] makeParallelSelectTestProvider() {
        ...
        return ParallelVariantFiltrationTestProvider.getTests(ParallelVariantFiltrationTestProvider.class);
    }

    @Test(dataProvider = "ParallelVariantFiltrationTest")
    public void testParallelSelectTestProvider(final ParallelVariantFiltrationTestProvider cfg) {
